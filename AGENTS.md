...
- **Código** pode ser escrito em inglês.
- **Comentários e documentação** devem ser escritos em português (pt-BR).
- **Conversa** (respostas, issues, PRs e discussões): use o idioma que o usuário preferir.
